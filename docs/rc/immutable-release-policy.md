...
- **P0/P1**：立即通知测试者停止使用，撤回当前 RC，撤销相关测试 Key。修复和完整回归后发布下一 RC。
...
撤回通知不得包含漏洞利用细节、完整 Key、账号信息或真实站点清单。测试者确认停止使用并完成清理后，才能关闭撤回动作。
...
- 当前 RC 的验收模型（rc.2 起为单人双浏览器）下，测试者完成主验收、交叉冒烟和约定窗口记录。
- P0、P1 和阻断型 P2 为零。
